  ...
  renderSelectedItems() {
    if (this.props.itemSeeds.length > 0) {
      return (
        <div>
          <p>
            Your mixtape's danceability, energy, instrumentalness, and song
    ...
    if (this.props.trackList.length > 0) {
      return (
        <div className="Playlist">
          <button
            ...
            onClick={this.handleTogglePlaylistDisplay}
          >
            <svg
          ...
          <div className="playlist-info">
            ...
            <input
              defaultValue="My New Mixtape"
              onChange={this.handleNameChange}
            />
            <button className="Playlist-save" onClick={this.props.onSave}>
              Save Mixtape to Spotify
            </button>
            <a
              className="close-playlist"
              onClick={this.handleTogglePlaylistDisplay}
            >
              Or create a new mixtape
            </a>
          </div>
          <TrackList
      ...
      return (
        <div className="empty-playlist">
          ...
          <p>
            Spotify was unable to create a mixtape that meets your requirements.
            Try selecting different genres or songs.
          </p>
