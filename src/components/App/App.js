...
class App extends Component {
  constructor(props) {
    ...
    this.handleMixtapeSuccessButton = this.handleMixtapeSuccessButton.bind(
      this
    );
  }
      ...
      return (
        <div className="App">
          ...
          <header>
            ...
            <a
              href="https://www.ryandestefano.com/magic-mixtape"
              target="_blank"
            >
              About
            </a>
          ...
          <div className="app-content">
            ...
            <div
              className={
                'mixtape-success ' + (this.state.displaySuccess ? 'active' : '')
              }
            >
              <h1>Success!</h1>
              <p>Your mixtape was saved to your Spotify account!</p>
              <button onClick={this.handleMixtapeSuccessButton}>
